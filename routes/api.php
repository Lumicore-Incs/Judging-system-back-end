...
Route::post('/get_all_student', [StudentControllers::class, 'getAllStudents']);
Route::get('/get_all_student_with_mark', [StudentControllers::class, 'getAllStudentsWithMark']);
...
Route::post('/upload-excel', [ExcelReadController::class, 'uploadExcel']);
